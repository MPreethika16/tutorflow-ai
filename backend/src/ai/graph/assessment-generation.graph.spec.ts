...
describe(
  ...
  () => {
    ...
    it(
      'retrieves, generates, validates, and persists a valid paper',
      async () => {
        aiServiceMock
          .generateStructured
          .mockResolvedValue(
    ...
    it(
      'repairs an invalid paper once and persists the valid repair',
      async () => {
        const invalidPaper = {
          ...validPaper,
    ...
    it(
      'uses two repairs when the first repair is still invalid',
      async () => {
    ...
    it(
      'stops after two failed repairs and does not persist',
      async () => {
        const invalidPaper = {
          ...validPaper,
    ...
    it(
      'uses teacher history before generating and persists the result',
      async () => {
        retrieverMock
          .retrieve
          .mockResolvedValue([
    ...
    it(
      'does not persist when initial AI generation fails',
      async () => {
        aiServiceMock
          .generateStructured
          .mockRejectedValue(
    ...
    it(
      'does not persist when teacher-style retrieval fails',
      async () => {
        retrieverMock
          .retrieve
          .mockRejectedValue(
    ...
    it(
      'propagates persistence failures after successful validation',
      async () => {
        aiServiceMock
          .generateStructured
          .mockResolvedValue(
